---
title: Quick Start
description: Install Turboism from an installer artifact, configure it, and verify the first run.
---

This quick start starts from an installer artifact as described in [Installation](./installation). You only need the installer artifact and an installed Cubism.
