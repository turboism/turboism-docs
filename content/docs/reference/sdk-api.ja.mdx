---
title: SDK API ガイド
description: 現在の Turboism plugin SDK の entrypoint、service、object model、lifecycle、capability boundary。
---
...
生成済み type と method の index については、[SDK HTML API reference](/api/sdk/index.html) を開いてください。
...
## Permission、capability、operation
